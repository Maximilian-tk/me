...
def wordy_pyramid():   
    list_of_lengths = list(range(3, 21, 2))
    words_ascending = list_of_words_with_lengths(list_of_lengths)
    list_of_lengths = list(range(20, 3, -2))
    words_descending = list_of_words_with_lengths(list_of_lengths)
    return words_ascending + words_descending
